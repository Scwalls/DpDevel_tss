#setwd("/scratch/tswenty/GoSTRIPES_sing/STRIPES/tsr_Cs")
...
#load("/scratch/tswenty/GoSTRIPES_sing/STRIPES/tsr_Cs/PdSTRIPE_complete.RData")
load("/scratch/scwalls/STRIPEseq_pipelines/GoSTRIPES_sing/STRIPES/tsr_Cs/PdSTRIPE_complete.RData")
...
plot_threshold_exploration(exp, samples="C1", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_C1.png")

plot_threshold_exploration(exp, samples="C2", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_C2.png")

plot_threshold_exploration(exp, samples="C3", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_C3.png")

#plot_threshold_exploration(exp, samples="As4", point_size=1) + scale_color_viridis_c()
#ggsave(file="threshold_Cs4.png")
...
ggsave(file="Cs_correlation_matrix.png")

### Genomic distribution analysis:
#### To update with new UTR-less annotation

plot_genomic_distribution(exp, data_type="tss", samples=c("C1", "C2","C3")) +
  scale_fill_viridis_d(direction=-1, name="Annotation")

ggsave(file="genomic_distribution_Cs.png")

### promoter fraction plot
#### To update with new UTR-less annotation
plot_detected_features(exp, data_type="tss", samples=c("C1", "C2","C3")) +
  scale_fill_viridis_d(direction=-1)

ggsave(file="promoter_fraction_Cs.png")

### Density plot
plot_density(exp, data_type="tss", samples="C1")
ggsave(file="TSS_density_CDS_C1.png")

plot_density(exp, data_type="tss", samples="C2")
ggsave(file="TSS_density_CDS_C2.png")

plot_density(exp, data_type="tss", samples="C3")
ggsave(file="TSS_density_CDS_C3.png")

#plot_density(exp, data_type="tss", samples="As4")
#ggsave(file="TSS_density_CDS_Cs4.png")

### TSS pileup heatmap
## need to update annotation/colour
plot_heatmap(
  exp, data_type="tss", samples="C1",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_C1.png")

plot_heatmap(
  exp, data_type="tss", samples="C2",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_Cs2.png")

plot_heatmap(
  exp, data_type="tss", samples="C3",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_C3.png")
...
#ggsave(file="TSS_pileup_Cs4.png")

### Sequence logo analysis- all three replicates
plot_sequence_logo(exp, samples="C1")
ggsave(file="C1_seq_logo.png")

plot_sequence_logo(exp, samples="C2")
ggsave(file="C2_seq_logo.png")

plot_sequence_logo(exp, samples="C3")
ggsave(file="C3_seq_logo.png")
...
plot_dinucleotide_frequencies(exp, samples="C1") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_C1.png")

plot_dinucleotide_frequencies(exp, samples="C2") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_C2.png")

plot_dinucleotide_frequencies(exp, samples="C3") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_C3.png")

#plot_dinucleotide_frequencies(exp, samples="As4") +
#  scale_fill_viridis_c()
#ggsave(file="dinucleotide_frequency_Cs4.png")

### TSS Sequence colour map

plot_sequence_colormap(exp, samples="C1", rasterize=TRUE)
ggsave(file="sequence_colormap_C1.png")
plot_sequence_colormap(exp, samples="C2", rasterize=TRUE)
ggsave(file="sequence_colormap_C2.png")
plot_sequence_colormap(exp, samples="C3", rasterize=TRUE)
ggsave(file="sequence_colormap_C3.png")
#plot_sequence_colormap(exp, samples="As4", rasterize=TRUE)
#ggsave(file="sequence_colormap_Cs4.png")
...
ggsave(file="plot_tsr_metrics_Cs.png")
...
ggsave(file="dinucl_motif_plot_shape_Cs.png")

plot_sequence_logo(exp, dominant=TRUE, samples="C1",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_C1.png")

plot_sequence_logo(exp, dominant=TRUE, samples="C2",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_C2.png")

plot_sequence_logo(exp, dominant=TRUE, samples="C3",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_C3.png")

#plot_sequence_logo(exp, dominant=TRUE, samples="As4",
#                   data_conditions=conditionals(data_grouping=shape_class)
#)

#ggsave(file="dinucl_motif_plot_shape_Cs4.png")
...
gene_tracks(
  ...
  samples=c(TSS="C1", TSR="C1")
)

ggsave(file="gene_track_C1_gene7125.png")
