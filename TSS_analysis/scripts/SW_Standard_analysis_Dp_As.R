...
plot_threshold_exploration(exp, samples="A1", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_A1.png")

plot_threshold_exploration(exp, samples="A2", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_A2.png")

plot_threshold_exploration(exp, samples="A3", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_A3.png")
...
plot_genomic_distribution(exp, data_type="tss", samples=c("A1", "A2","A3")) +
...
#### To update with new UTR-less annotation
plot_detected_features(exp, data_type="tss", samples=c("A1", "A2","A3")) +
  scale_fill_viridis_d(direction=-1)

ggsave(file="promoter_fraction_As.png")

### Density plot
plot_density(exp, data_type="tss", samples="A1")
ggsave(file="TSS_density_CDS_A1.png")

plot_density(exp, data_type="tss", samples="A2")
ggsave(file="TSS_density_CDS_A2.png")

plot_density(exp, data_type="tss", samples="A3")
ggsave(file="TSS_density_CDS_A3.png")
...
plot_heatmap(
  exp, data_type="tss", samples="A1",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_A1.png")

plot_heatmap(
  exp, data_type="tss", samples="A2",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)
...
plot_heatmap(
  exp, data_type="tss", samples="A3",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_A3.png")
...
plot_sequence_logo(exp, samples="A1")
ggsave(file="A1_seq_logo.png")

plot_sequence_logo(exp, samples="A2")
ggsave(file="A2_seq_logo.png")

plot_sequence_logo(exp, samples="A3")
ggsave(file="A3_seq_logo.png")
...
plot_dinucleotide_frequencies(exp, samples="A1") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_A1.png")

plot_dinucleotide_frequencies(exp, samples="A2") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_A2.png")

plot_dinucleotide_frequencies(exp, samples="A3") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_A3.png")
...
plot_sequence_colormap(exp, samples="A1", rasterize=TRUE)
ggsave(file="sequence_colormap_A1.png")
plot_sequence_colormap(exp, samples="A2", rasterize=TRUE)
ggsave(file="sequence_colormap_A2.png")
plot_sequence_colormap(exp, samples="A3", rasterize=TRUE)
ggsave(file="sequence_colormap_A3.png")
...
plot_sequence_logo(exp, dominant=TRUE, samples="A1",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_A1.png")

plot_sequence_logo(exp, dominant=TRUE, samples="A2",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_A2.png")

plot_sequence_logo(exp, dominant=TRUE, samples="A3",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_A3.png")
