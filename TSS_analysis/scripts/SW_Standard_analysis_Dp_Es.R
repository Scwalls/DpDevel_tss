#setwd("/scratch/tswenty/GoSTRIPES_sing/STRIPES/tsr_Es")
...
load("/scratch/scwalls/STRIPEseq_pipelines/GoSTRIPES_sing/STRIPES/tsr_Es/PdSTRIPE_complete.RData")
...
plot_threshold_exploration(exp, samples="E1", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_E1.png")

plot_threshold_exploration(exp, samples="E2", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_E2.png")

plot_threshold_exploration(exp, samples="E3", point_size=1) + scale_color_viridis_c()
ggsave(file="threshold_E3.png")
...
ggsave(file="Es_correlation_matrix.png")

### Genomic distribution analysis:
#### To update with new UTR-less annotation

plot_genomic_distribution(exp, data_type="tss", samples=c("E1", "E2","E3")) +
  scale_fill_viridis_d(direction=-1, name="Annotation")

ggsave(file="genomic_distribution_Es.png")

### promoter fraction plot
#### To update with new UTR-less annotation
plot_detected_features(exp, data_type="tss", samples=c("E1", "E2","E3")) +
  scale_fill_viridis_d(direction=-1)

ggsave(file="promoter_fraction_Es.png")

### Density plot
plot_density(exp, data_type="tss", samples="E1")
ggsave(file="TSS_density_CDS_E1.png")

plot_density(exp, data_type="tss", samples="E2")
ggsave(file="TSS_density_CDS_E2.png")

plot_density(exp, data_type="tss", samples="E3")
ggsave(file="TSS_density_CDS_E3.png")
...
plot_heatmap(
  exp, data_type="tss", samples="E1",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_E1.png")

plot_heatmap(
  exp, data_type="tss", samples="E2",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_Es2.png")

plot_heatmap(
  exp, data_type="tss", samples="E3",
  upstream=250, downstream=250,
  use_normalized=TRUE,
  rasterize=TRUE, raster_dpi=150
)

ggsave(file="TSS_pileup_E3.png")
...
plot_sequence_logo(exp, samples="E1")
ggsave(file="E1_seq_logo.png")

plot_sequence_logo(exp, samples="E2")
ggsave(file="E2_seq_logo.png")

plot_sequence_logo(exp, samples="E3")
ggsave(file="E3_seq_logo.png")
...
plot_dinucleotide_frequencies(exp, samples="E1") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_E1.png")

plot_dinucleotide_frequencies(exp, samples="E2") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_E2.png")

plot_dinucleotide_frequencies(exp, samples="E3") +
  scale_fill_viridis_c()
ggsave(file="dinucleotide_frequency_E3.png")
...
plot_sequence_colormap(exp, samples="E1", rasterize=TRUE)
ggsave(file="sequence_colormap_E1.png")
plot_sequence_colormap(exp, samples="E2", rasterize=TRUE)
ggsave(file="sequence_colormap_E2.png")
plot_sequence_colormap(exp, samples="E3", rasterize=TRUE)
ggsave(file="sequence_colormap_E3.png")
...
ggsave(file="plot_tsr_metrics_Es.png")
...
ggsave(file="dinucl_motif_plot_shape_Es.png")

plot_sequence_logo(exp, dominant=TRUE, samples="E1",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_E1.png")

plot_sequence_logo(exp, dominant=TRUE, samples="E2",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_E2.png")

plot_sequence_logo(exp, dominant=TRUE, samples="E3",
                   data_conditions=conditionals(data_grouping=shape_class)
)

ggsave(file="dinucl_motif_plot_shape_E3.png")
...
gene_tracks(
  ...
  samples=c(TSS="E1", TSR="E1")
)

ggsave(file="gene_track_E1_gene7125.png")
